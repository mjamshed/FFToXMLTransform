 ...
 *       &lt;sequence>
 *         &lt;element ref="{}GlobalProductIdentifier" minOccurs="0"/>
 *         &lt;element ref="{}PartnerProductIdentification" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ProductIdentification")
public class ProductIdentification {
    ...
    protected List<PartnerProductIdentification> partnerProductIdentification;
     ...
     * {@link PartnerProductIdentification }
     * 
     * 
     */
    public List<PartnerProductIdentification> getPartnerProductIdentification() {
        if (partnerProductIdentification == null) {
            partnerProductIdentification = new ArrayList<PartnerProductIdentification>();
        }
