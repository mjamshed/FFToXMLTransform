 ...
 *       &lt;sequence>
 *         &lt;element ref="{}AffirmationIndicator"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "isContainsHazardousMaterial")
public class IsContainsHazardousMaterial {

    @XmlElement(name = "AffirmationIndicator", required = true)
    protected String affirmationIndicator;
     ...
     *     
     */
    public String getAffirmationIndicator() {
     ...
     *     
     */
    public void setAffirmationIndicator(String value) {
