 ...
 *       &lt;sequence>
 *         &lt;element ref="{}CommunicationsNumber"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "facsimileNumber")
public class FacsimileNumber {

    @XmlElement(name = "CommunicationsNumber", required = true)
    protected String communicationsNumber;
     ...
     *     
     */
    public String getCommunicationsNumber() {
     ...
     *     
     */
    public void setCommunicationsNumber(String value) {
